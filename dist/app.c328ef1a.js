...
function upload(selector) {
  ...
  upload.style.display = 'none'; // Set input attributes
  ...
  input.insertAdjacentElement('afterend', open); // Input trigger
  ...
  var changeHandler = function changeHandler(event) {
    ...
    files.forEach(function (file) {
      ...
      reader.onload = function (ev) {
        ...
        preview.insertAdjacentHTML('afterbegin', "\n\t\t\t\t\t<div class=\"preview-image\">\n\t\t\t\t\t\t<div class=\"preview-remove\" data-name=\"".concat(file.name, "\" title=\"\u0423\u0434\u0430\u043B\u0438\u0442\u044C \u0438\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u0435\">&times;</div>\n\t\t\t\t\t\t<img src=\"").concat(src, "\" alt=\"").concat(file.name, "\" title=\"").concat(file.name, "\">\n\t\t\t\t\t\t<div class=\"preview-info\">\n\t\t\t\t\t\t\t<div class=\"file-name\">").concat(file.name, "</div>\n\t\t\t\t\t\t\t<div class=\"file-size\">").concat(bytesToSize(file.size), "</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t"));
      };
    });
  }; // Remove handler
  ...
  var removeHandler = function removeHandler(event) {
    ...
    var block = preview.querySelector(".preview-remove[data-name=\"".concat(name, "\"]")).closest('.preview-image');
